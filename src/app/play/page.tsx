  ...
  return (
    <PageLayout activePath='/play'>
      <div className='flex flex-col px-0 lg:px-[5rem] 2xl:px-32'>
        {/* 播放器顶部信息栏 - 简化设计 */}
        <div className='flex flex-col lg:flex-row lg:items-center justify-between gap-4 px-4 lg:px-0 h-16'>
          {/* 左侧：返回按钮和影片标题 */}
          <div className='flex items-center gap-4 flex-1 min-w-0'>
            {/* 返回箭头 - 简化设计 */}
            <button
              onClick={() => router.back()}
              className='flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 transition-colors duration-200'
              aria-label='返回上一页'
            >
            ...
            <div className='flex-1 min-w-0'>
              <h1 className='text-xl font-bold text-gray-800 dark:text-gray-200 truncate'>
                {videoTitle || '影片标题'}
                {totalEpisodes > 1 && (
                  <span className='text-green-600 dark:text-green-400 ml-2 text-lg'>
                ...
                <div className='space-y-4'>
                  ...
                  <div>
                    ...
                    <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 mb-6'>
                      ...
                      {(detail?.year || videoYear) && (
                        <div className='text-center'>
                          <div className='text-sm text-gray-500 dark:text-gray-400 mb-1'>上映</div>
                  ...
                  {detail?.desc && (
                    <div>
                      <h3 className='text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3'>剧情简介</h3>
                      <div 
